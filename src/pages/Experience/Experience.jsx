...
const ExperienceSection = () => {
  const experiences = [
    {
      ...
      description:
        "Developed, maintained and optimized enterprise Java applications (Spring, Struts, JSP, Oracle).",
    },
    {
      icon: Layers,
  ...
  return (
    <>
      <div id="experience" className="bg-gradient-to-b relative overflow-hidden pt-32 pb-20">
